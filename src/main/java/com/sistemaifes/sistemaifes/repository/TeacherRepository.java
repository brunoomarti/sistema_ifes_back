...
public interface TeacherRepository extends JpaRepository<Teacher, Long>{
    ...
    @Query(value = """
			...
			WITH NextLesson AS (
                               SELECT
                                   ...
                                   TO_TIMESTAMP(TO_CHAR(CURRENT_DATE, 'YYYY-MM-DD') || ' ' || s.start_time, 'YYYY-MM-DD HH24:MI') AS start_time_ts,
                               ...
                               WHERE
                                   ...
                                   AND TO_TIMESTAMP(TO_CHAR(CURRENT_DATE, 'YYYY-MM-DD') || ' ' || s.start_time, 'YYYY-MM-DD HH24:MI') > NOW()
                                   AND CASE
                                   ...
                                   END = a.week_day
                               ORDER BY
                                   TO_TIMESTAMP(TO_CHAR(CURRENT_DATE, 'YYYY-MM-DD') || ' ' || s.start_time, 'YYYY-MM-DD HH24:MI') ASC
                               LIMIT 1
                           )
                           SELECT
                               nl.teacher_name,
   ...
   """, nativeQuery = true)
    Object findNextLessonByTeacherCode(String teacherCode);
}
